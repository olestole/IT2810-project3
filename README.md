...
- **/frontend**
  ...
  - **/cypress**: Cypress testing files. (Read more under [testing](#testing))<br>
...
We use a MERN stack with GraphQL. More specifically we are using MongoDB, Express, React with Typescript and Node.js. In addition we are using Apollo Client on the frontend and Apollo server on the backend. We integrate Mongoose for interaction with MongoDB and Auth0 for authentication.
